...
def generate_launch_description():
    ...
    # 3. Otak Lokalisasi Alvin
    # Harus didaftarkan di setup.py NUC terlebih dahulu dengan executable 'Lokalisasi_Alvin'
    localization_node = Node(
        package='Lokalisasi',
        executable='Lokalisasi_Alvin',
        name='improved_op3_localization_alvin',
        output='screen'
    )
