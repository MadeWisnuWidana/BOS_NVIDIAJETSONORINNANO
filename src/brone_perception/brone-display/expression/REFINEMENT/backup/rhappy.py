...
pygame.display.set_caption("Robot Face - HAPPY (Fully Optimized & Saccade Ready)")
...
# --- 4. PRE-RENDER & PRE-CALCULATE (BEBAS REDUNDANSI) ---

# A. Pre-Render Gradasi Mata (Dihitung 1x saja)
...
# B. Pre-Calculate Titik Mulut Happy (Dihitung 1x saja)
mouth_w = 320        
mouth_top_y = 420    
curve_top_sag = 30   
...
def draw_eye_gradient(surface, rect, pup_ox=0, pup_oy=0):
    ...
    # Glint bergeser mengikuti pup_ox dan pup_oy
...
while running:
    ...
    # 2. MATA & KELOPAK
    # Nilai pup_ox dan pup_oy bisa BISA diisi angka nanti untuk bikin mata lirik riilik
    ...
    # 3. MULUT (Optimasi Local Masking)
    pygame.draw.polygon(screen, MOUTH_DARK, STATIC_MOUTH_POINTS)

    # Kanvas memori kecil (Hanya seukuran mulut, BUKAN seukuran layar)
